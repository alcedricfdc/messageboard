<div class="participants index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $participant['Participant']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $participant['Participant']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
